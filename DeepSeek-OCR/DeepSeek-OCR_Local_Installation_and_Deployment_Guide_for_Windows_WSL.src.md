...
<!-- include: _partials/zh/deepseek-ocr/weights.md -->
<!-- include: _partials/zh/deepseek-ocr/env.md -->
<!-- include: _partials/zh/deepseek-ocr/install-cuda.md -->
<!-- include: _partials/zh/deepseek-ocr/vllm.md -->
<!-- include: _partials/zh/deepseek-ocr/start-vllm.md -->
<!-- include: _partials/zh/common/vibeocr.md -->
<!-- include: _partials/zh/deepseek-ocr/clone.md -->
# ⚠️ 注意事项
